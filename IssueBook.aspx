<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IssueBook.aspx.cs" Inherits="Unity_Library_Management_System.frmIssueBook" %>
...
<body style="background-color:black">
    ...
    <form id="form1" runat="server">
        <div class="navbar navbar-inverse navbar-fixed-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" runat="server" href="HomePage.aspx">Keiser Library
                    <asp:Image ID="Image1" runat="server" Height="60px" ImageUrl="~/ResourceImages/bibek.PNG" Width="182px" />
                    ...
                    <asp:LoginView runat="server" ViewStateMode="Disabled">
                        <AnonymousTemplate>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li><a runat="server" id="register" href="frmRegister.aspx">Register</a></li>
        ...
        <div class="jumbotron">
            ...
            <asp:GridView ID="GridView1" CssClass="table table-hover table-responsive table-striped" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="IssueID" DataSourceID="SqlDataSource1" ForeColor="Black" GridLines="Horizontal" AllowSorting="True">
                <Columns>
